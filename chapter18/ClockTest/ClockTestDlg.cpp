...
void CClockTestDlg::OnButtonAdd() 
{
	// TODO: Add your control notification handler code here
    if(m_clock.GetSafeHwnd() == NULL)
        m_clock.Create("Clock", WS_CHILD | WS_VISIBLE, CRect(0, 0, 100, 50), this, 123); 
    else 
    {
        int r, g, b; 
        r = rand() % 255; 
        g = rand() % 255; 
        b = rand() % 255; 
        m_clock.SetBackColor(RGB(r, g, b)); 
        m_clock.SetForeColor(RGB(255-r, 255-g, 255-b)); 
        if(m_clock.GetBackColor() == RGB(0, 0, 0))
            m_clock.Hello(); 
    }
}
...
{
	// TODO: Add your control notification handler code here
	MessageBox("New Minute for 1"); 
}

void CClockTestDlg::OnNewMinuteClockctrl2() 
{
	// TODO: Add your control notification handler code here
	MessageBox("New Minute for 2"); 
}

void CClockTestDlg::OnClickClockctrl2() 
{
	// TODO: Add your control notification handler code here
	MessageBox("Click for 2"); 
}
